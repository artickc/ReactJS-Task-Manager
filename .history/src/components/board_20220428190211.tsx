...
export const Board: React.FC = () => {
 ...
 let titleValidation: boolean = false;
 let deadLineValidation: boolean = false;
 let descriptionValidation: boolean = false;
 ...
 const updateOrCreateTask = () => {
  if (titleValidation || deadLineValidation || descriptionValidation)
   return false;
    ...
    >
     ...
     <DialogContent>
      ...
      <TextField
       ...
       error={titleValidation && workingObject.title.length <= MIN_LENGTH}
      ...
      <MUIRichTextEditor
       ...
       error={
        descriptionValidation && workingObject.description.length <= MIN_LENGTH
       }
