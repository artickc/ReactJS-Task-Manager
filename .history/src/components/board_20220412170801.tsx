...
export const Board: React.FC = () => {
 ...
 const deadlineParse = active.deadline.split(" ");
 ...
 const activeDeadLine = Date.parse(deadline);

 const deadLine = active.id ? activeDeadLine : new Date();
 ...
 const [value, setValue] = React.useState<Date | null>(new Date(deadLine));
