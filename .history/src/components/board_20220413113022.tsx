...
export const Board: React.FC = () => {
 ...
 const onEditorChange = (event: any) => {
  ...
  const rteContent = convertToRaw(event.getCurrentContent()).blocks[0].text; // for rte content with text formating

  //   workingObject.description = rteContent; // store your rteContent to state
