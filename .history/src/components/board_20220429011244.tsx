...
export const Board: React.FC = () => {
 ...
 const onEditorChange = (event: any) => {
  ...
  let rteContent = stateToHTML(event.getCurrentContent());
     ...
     <DialogActions>
      ...
      <Button
       disabled={
        ...
        (workingObject.edited && workingObject.errors.length > 0) ||
        (workingObject.errors.length == 0 && !workingObject.edited)
         ? true
         : false
       }
