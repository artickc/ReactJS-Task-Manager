...
export const DenseAppBar: React.FC = () => {
  ...
  (event: React.KeyboardEvent | React.MouseEvent) => {
    ...
    console.log(sidebar)
      try{
        Dispatch<AppAction>({type:AppActionTypes.OPEN_APP_SIDEBAR, payload: sidebar?false:true})
      } catch (e){
        Dispatch<AppAction>({type:AppActionTypes.FETCH_APP_ERROR, payload: 'Unable to change sidebar state'})
      }
