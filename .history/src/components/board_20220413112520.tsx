...
import MUIRichTextEditor, { TDraftEditorProps, TMUIRichTextEditorRef } from "mui-rte";
...
import {EditorOptions, IndexType, ObjectBindingOrAssignmentPattern} from "typescript";
...
export const Board: React.FC = () => {
 ...
 const onEditorChange = (event: Draft.Model.ImmutableData.EditorState) => {
    const plainText = event.getCurrentContent().getPlainText() // for plain text
    const rteContent = convertToRaw(event.getCurrentContent())) // for rte content with text formating
    workingObject.description = JSON.stringify(rteContent)) // store your rteContent to state
    console.log(workingObject.description);
  }
