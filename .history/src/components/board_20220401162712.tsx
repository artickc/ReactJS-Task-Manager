...
import {NOXXMultiSelect, NOXXOption} from "./select";
    ...
    >
     ...
     <DialogContent>
      ...
      <NOXXMultiSelect defaultValue={[10, 20]}>
       <NOXXOption value={10}>Ten</NOXXOption>
       <NOXXOption value={20}>Twenty</NOXXOption>
       <NOXXOption value={30}>Thirty</NOXXOption>
       <NOXXOption value={40}>Forty</NOXXOption>
       <NOXXOption value={50}>Fifty</NOXXOption>
      </NOXXMultiSelect>
     </DialogContent>
     <DialogActions>
